...
![Views Profiling](../assets/img/posts/timelineview/views_profiling.png)

As one can see there is a lot going on with the core animation and view rendering.

![CPU Usage](../assets/img/posts/timelineview/views_cpu_usage.png)
...
![Shader stars](../assets/img/posts/timelineview/swiftui_stars.gif)
...
![Shader stars](../assets/img/posts/timelineview/canvas_stars.gif)

With less cpu:

![CPU Canvas](../assets/img/posts/timelineview/canvas_cpu_usage.png)

And less animation and drwaing overhead:

![Profiling Canvas](../assets/img/posts/timelineview/canvas_profiling.png)
