...
# Solving with the DispatchQueue
...
It's still doesn't work. That's because our printAll method is accessing the dictionary directly, because of that it needs to be synchronized too!
